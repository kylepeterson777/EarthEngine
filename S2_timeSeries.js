// This script processes and charts WQ parameter values from a collection of Sentinel-2 archive for a given location throughout time.
// How to use:
...
// Citation: 
// Page, B.P., Kumar, A. and Mishra, D.R., 2018. 
...
//////////////////////////////////////////////////////////////////////////////////
// calculate water quality variables
...
function secchi(img){
  ...
  var MOSD_coll = (ee.Image(1.4856).multiply(blueRed_coll)).add(ee.Image(0.2734)); 
